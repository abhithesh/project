...
def read_dataset(path):
    ...
    label_list = []
    i=-1
    my_list = os.listdir(r'C:\Users\heman\OneDrive\Desktop\Project_File\web\static\train')
    for pa in my_list:
        i=i+1
        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\heman\OneDrive\Desktop\Project_File\web\static\train\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\heman\OneDrive\Desktop\Project_File\web\static\train\\'+pa, f)
...
def predict(fn):
    ...
    mo = load_model(r"C:\Users\heman\OneDrive\Desktop\Project_File\web\model1.h5")
    dataset = dataset/255
...
res = predict(r"C:\Users\heman\OneDrive\Desktop\Project_File\web\sample.jpg")

if res[0]==0:
    print("Predicted result : MildDemented")
elif res[0]==1:
    print("Predicted result : ModerateDemented")
elif res[0]==2:
    print("Predicted result : NonDemented")
elif res[0]==3:
    print("Predicted result : VeryMildDemented")
